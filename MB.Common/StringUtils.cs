...
namespace MB.Common
{
    public class StringUtils
    {
        ...
        public static string GetLowerRandom(int length)
        {
            return MakeRandomCharacter("LOWER", length);
        }
        ...
        /// <returns>随机字符串</returns>
        public static string GetUpperRandom(int length)
        {
            return MakeRandomCharacter("UPPER", length);
        }
        ...
        {
            return MakeRandomCharacter("NUMBER", length);
        }
        ...
        {
            return MakeRandomCharacter("ALL", length);
        }
