...
namespace MB.DAL
{
    ...
    public partial class vPlanList
    {
        ...
        public Nullable<int> schemaName { get; set; }
        public Nullable<int> orderNumber { get; set; }
        public string confirmUserName { get; set; }
        public string confirmUserImage { get; set; }
        public string createUserName { get; set; }
        public Nullable<int> projectId { get; set; }
        public Nullable<bool> responsibleUserDeleteFlag { get; set; }
        public Nullable<int> responsibleUserWorkStatus { get; set; }
        public Nullable<bool> confirmUserDeleteFlag { get; set; }
        public Nullable<int> confirmUserWorkStatus { get; set; }
