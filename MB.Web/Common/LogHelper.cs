...
namespace MB.Web.Common
{
    public class LogHelper
    {
        ...
        public static void Output(string logName, EnumDefine.ErrorLevel level, string formatString, object[] args, Exception ex)
        {
            lock (lockHelper)
            {
                ...
                switch (level)
                {
                    case EnumDefine.ErrorLevel.INFO:
                    ...
                    case EnumDefine.ErrorLevel.DEBUG:
                    ...
                    case EnumDefine.ErrorLevel.WARN:
                    ...
                    case EnumDefine.ErrorLevel.ERROR:
                    ...
                    case EnumDefine.ErrorLevel.FATAL:
        ...
        public static void Output(string logName, EnumDefine.ErrorLevel level, string message)
        {
        ...
        /// <param name="level">Log等级</param>
        /// <param name="prm_exception_ex">异常</param>
        public static void Output(string logName, EnumDefine.ErrorLevel level, Exception ex)
        {
