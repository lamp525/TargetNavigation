...
namespace MB.BLL.Test
{
    ...
    public abstract class SqlHelper
    {
        ...
        /// <param name="tableName">要更新到数据库的DataTable</param> 
        /// <returns>返回影响的行数</returns>
        public static int UpdateDataset(SqlCommand insertCommand, SqlCommand deleteCommand, SqlCommand updateCommand, DataSet dataSet, int tableIndex)
        {
            if (insertCommand == null) throw new ArgumentNullException("insertCommand");
            if (deleteCommand == null) throw new ArgumentNullException("deleteCommand");
            if (updateCommand == null) throw new ArgumentNullException("updateCommand");
            ...
            using (SqlDataAdapter dataAdapter = new SqlDataAdapter())
            {
                ...
                dataAdapter.DeleteCommand = deleteCommand;
                // 更新数据集改变到数据库 
                int i = dataAdapter.Update(dataSet.Tables[tableIndex]);
